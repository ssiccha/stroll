#ifndef FUSING_ALGORITHM_BUILDER_DEPTHFIRST_SIMPLE
#define FUSING_ALGORITHM_BUILDER_DEPTHFIRST_SIMPLE
        ...
        namespace simple {
            ...
            class fusing_algorithm_builder {
              ...
              public:    
                ...
                inline fusing_algorithm_builder(unsigned x, unsigned n, unsigned debug = 0);
            ...
            struct fusing_algorithm_builder<LABRA>::Algorithm {
                ...
                Algorithm(VARIABLES const& v) : var(v), debug(0) {}
                Algorithm(unsigned d) : debug(d) {}
                Algorithm() : debug(0) {}
                void operator()();
                VARIABLES   var;
            ...
            template <class LABRA>
            fusing_algorithm_builder<LABRA>::fusing_algorithm_builder(unsigned _x, unsigned n, unsigned d ) 
                :   algo(d!=0?_x:0) 
                ,   x(_x-1) {
                Build_VarphiHom();
                Build_SmallerOrEqual(n);
...
#endif // FUSING_ALGORITHM_BUILDER_DEPTHFIRST_SIMPLE
