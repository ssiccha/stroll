...
#define BOOST_TEST_MODULE algorithm_depthfirst_simple_splitting
...
// INIT END //////////////////////////
    ...
    using laddergame::depthfirst::simple::splitting_algorithm;
    ...
    findOrbitRepresentativeStore<LABRA> findIt(omega);
    ALGORITHM::CANFKT FindOrbitRep = findIt;
    ...
    splitting_algorithm<SQUARE>::Variables var = {e1,e2,a1,b1,b2,C1,C2};
    splitting_algorithm<SQUARE>::Functions f = {Psi1,VarphiInv,FindOrbitRep,test,SmallerOrEqual,step1,step2};
...
void PrintResults(typename LABRA::GROUP_element_type& g, 
    ...
    template <class LABRA>
    void CheckResults<LABRA>::operator()(GRELM& e1, GRELM& b1 ) {
/*
        //gebe Ergebnisse aus
        if ( IsResult )
