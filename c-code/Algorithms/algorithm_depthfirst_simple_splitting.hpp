#ifndef LADDERGAME_DEPTHFIRST_SIMPLE_SPLITTING_ALGORITHM
#define LADDERGAME_DEPTHFIRST_SIMPLE_SPLITTING_ALGORITHM
    ...
    namespace depthfirst {
        ...
        namespace simple {
            ...
            void splitting_algorithm<SQUARE,RANGE>::operator () ( Variables const& v, Functions& f ) const {
                ...
                (*this)(v.e1,v.e2,v.a1,v.b1,v.b2,v.C1,v.C2,f.Psi1,f.VarphiInv,f.FindOrbitRep,f.test,f.SmallerOrEqual,f.step1,f.step2);
            }
                                                                    ...
                                                                    STEPFKT&        step2      ) const 
            {
                ...
                foreach(e1, VarphiInv(e2) ) {
                    ...
                    else if ( false == SmallerOrEqual(a1,Psi1(e1<<b1)) )
                        step2(e1,b1);

                    else if ( false == test(e1,b1) )
                        continue;
...
#endif // LADDERGAME_DEPTHFIRST_SIMPLE_SPLITTING_ALGORITHM
